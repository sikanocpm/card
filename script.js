// Animaciones y efectos interactivos para la tarjeta CHIVOX FF
...
function initImageFallback() {
    ...
    profileImg.onerror = function() {
        this.src = 'data:image/svg+xml;base64,';
        this.alt = 'CHIVOX FF Logo';
    };
}
...
function initSocialHover() {
    ...
    socialLinks.forEach(link => {
        ...
        link.addEventListener('mouseenter', function() {
            ...
            // Efecto de brillo
            this.style.boxShadow = '0 15px 35px rgba(139, 0, 0, 0.4), 0 0 20px rgba(139, 0, 0, 0.2)';
        });
...
console.log('🎮 CHIVOX FF Card inicializada correctamente');
